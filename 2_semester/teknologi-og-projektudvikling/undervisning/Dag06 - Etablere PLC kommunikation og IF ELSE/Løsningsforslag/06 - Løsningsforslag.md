...
try:
    while True:
        ...
        # =========== Logik ============================
        if i00 and not i01: # Hvis S1 er trykket og S2 ikke registrerer et objekt
            q00 = True # Start transportbåndet (sæt Q1)
        elif i01: # Hvis S2 registrerer et objekt
            q00 = False # Stop transportbåndet (sluk Q1)

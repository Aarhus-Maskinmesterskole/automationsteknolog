...
\subsection{Factory Acceptance Test (FAT)}
...
Integration Test      & Factory Acceptance Test: PLC $\leftrightarrow$ Python & Tabel i afsnit~6.1\\
System Test           & Fuld sekvens: IDLE$\to$FILL$\to$ALARM$\to$RESET & Afsnit 6.1 \\

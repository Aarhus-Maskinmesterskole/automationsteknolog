# 05 – Real‑time Logger til .txt (pycomm3)
...
- Gemme data i tekstfil med tidsstempel
...
Hvis du bruger `with LogixDriver(...) as plc:` bliver forbindelsen automatisk lukket, når du forlader blokken.

Hvis du vil stoppe pænt med `Ctrl+C`, kan du strukturere din kode sådan her:
...
try:
    ...
    # Her kan du lukke andre ressourcer (fx filer) hvis du selv har dem åbne
    pass
```
...
* læse flere tags med samme mønster,
* logge data med tidsstempel til en tekstfil,
* genforbinde efter netværksfejl,
* stoppe programmer pænt med `Ctrl+C`.

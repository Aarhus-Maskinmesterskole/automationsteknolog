# Opgave 8: ESP32 + RGBW LED som Modbus TCP server

Mål: tænd rød, grøn, blå og hvid fra Node-RED.
...
* Lav fire `modbus write` noder
* Function = `Coil (FC5)`
* Address = `0`, `1`, `2` og `3`
* Payload = `true` eller `false`

Hver coil tænder én LED: rød, grøn, blå eller hvid.